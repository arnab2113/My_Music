...
const seedData = async () => {
  try {
    ...
    console.log('[Seed] Users created: admin@nostalgiafm.com & user@nostalgiafm.com');
    ...
    const artistsData = [
      ...
      { name: 'Alka Yagnik', bio: 'Legendary Indian playback singer with 7 Filmfare awards.', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=600&q=80', genre: 'Hindi 90s' },
      { name: 'Udit Narayan', bio: 'Golden voice of 90s and 2000s Hindi cinema.', image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=600&q=80', genre: 'Hindi 90s' },
      { name: 'Hemanta Mukherjee', bio: 'Iconic maestro of Bengali modern & film classics.', image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=600&q=80', genre: 'Bengali Classics' },
      { name: 'Manna Dey', bio: 'Classical fusion & Bengali Adhunik legend.', image: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=600&q=80', genre: 'Bengali Classics' },
      { name: 'Khesari Lal Yadav', bio: 'High energy Bhojpuri folk & film superstar.', image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=600&q=80', genre: 'Bhojpuri Hits' },
      ...
      { name: 'A.R. Rahman', bio: 'Mozart of Madras - Pioneer of modern Indian soundscapes.', image: 'https://images.unsplash.com/photo-1511379938547-c1f69419868d?auto=format&fit=crop&w=600&q=80', genre: 'Romantic Nights' }
    ];
    const createdArtists = await Artist.insertMany(artistsData);
    console.log(`[Seed] ${createdArtists.length} Artists created.`);
    ...
    const albumsData = [
      ...
      { title: 'Sonar Bangla Golden Melodies', artist: createdArtists[3]._id, releaseYear: 1985, cover: 'https://images.unsplash.com/photo-1445985543470-41fba5c3144a?auto=format&fit=crop&w=600&q=80', description: 'Soulful Bengali classics and Adhunik song compilation.' },
      ...
      { title: 'Retro Nights Pancham Beats', artist: createdArtists[6]._id, releaseYear: 1982, cover: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&w=600&q=80', description: 'Funky brass, electric bass and 80s vinyl warmth.' },
    ...
    console.log(`[Seed] ${createdAlbums.length} Albums created.`);

    // 4. Seed 22 Songs across genres
    const songsRawData = [
      // Hindi 90s
    ...
    console.log(`[Seed] ${createdSongs.length} Songs created successfully.`);

    // Update album song references
    ...
    // 5. Seed Radio Stations and assign song IDs
    ...
    const createdStations = await RadioStation.insertMany(stationsData);
    console.log(`[Seed] ${createdStations.length} Radio Stations created.`);
    ...
    console.log(`[Seed] ${themesData.length} Themes created.`);

    // 7. Seed Ambient Sounds
    ...
    console.log(`[Seed] ${ambientSoundsData.length} Ambient Sounds created.`);

    // 8. Seed Default Playlists with valid created song IDs
